...
public class TestSimpleJoins extends SqlTestCase {
    ...
    /**
     * This test performs an right outer join between a empty table (right) and a non-empty table.
     * @throws Throwable
     */
    ...
    /**
     * This test performs an right outer join between a empty table (left) and a non-empty table.
     * @throws Throwable
     */
    ...
    /**
     * This tests performs an right outer join between two nonempty tables where multiple rows of
     * the right table would join.
     * @throws Throwable
     */
    public void testROJEmptyDupRight() throws Throwable {
        TupleLiteral[] expected = {
            new TupleLiteral(10, 1, 1, 100),
            new TupleLiteral(20, 2, 2, 200),
            new TupleLiteral(20, 2, 2, 222),
     ...
     * @throws Throwable
     */
    public void testROJEmptyDupLeft() throws Throwable {
        TupleLiteral[] expected = {
                new TupleLiteral(10, 1, 1, 100),
                new TupleLiteral(20, 2, 2, 200),
                new TupleLiteral(22, 2, 2, 200),
